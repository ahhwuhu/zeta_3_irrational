...
\begin{definition}
  \label{def:IsSequence}
  \lean{IMO2025P4.IsSequence}
  \leanok
  \uses{def:S}
  1
\end{definition}
...
\begin{lemma}
  \label{lem:odd_successor_is_odd}
  \lean{IMO2025P4.lem_odd_successor_is_odd}
  \leanok
  \uses{def:S}
  1
\end{lemma}
...
\begin{lemma}
  \label{lem:odd_implies_all_odd}
  \lean{IMO2025P4.lem_odd_implies_all_odd}
  \leanok
  \uses{def:IsSequence, lem:odd_successor_is_odd}
  1
\end{lemma}
\begin{proof}
  \leanok
  \uses{lem:odd_successor_is_odd}
  1
\end{proof}

\begin{lemma}
  \label{lem:ratio_for_odd}
  \lean{IMO2025P4.lem_ratio_for_odd}
  \leanok
  \uses{def:R}
  1
\end{lemma}
...
\begin{lemma}
  \label{lem:odd_implies_decreasing}
  \lean{IMO2025P4.lem_odd_implies_decreasing}
  \leanok
  \uses{def:IsSequence, def:R}
  1
\end{lemma}
\begin{proof}
  \leanok
  \uses{lem:ratio_for_odd, lem:odd_implies_all_odd}
  1
\end{proof}

\begin{lemma}
  \label{lem:no_odd_terms}
  \lean{IMO2025P4.lem_no_odd_terms}
  \leanok
  \uses{def:IsSequence}
  1
\end{lemma}
\begin{proof}
  \leanok
  \uses{lem:odd_implies_decreasing}
  1
\end{proof}

\begin{lemma}
  \label{lem:all_terms_even}
  \lean{IMO2025P4.lem_all_terms_even}
  \leanok
  \uses{def:IsSequence}
  1
\end{lemma}
\begin{proof}
  \leanok
  \uses{lem:no_odd_terms}
  1
\end{proof}

\begin{lemma}
  \label{lem:c2_is_2}
  \lean{IMO2025P4.lem_c2_is_2}
  \leanok
  \uses{def:IsSequence, def:c_k}
  1
\end{lemma}
\begin{proof}
  \leanok
  \uses{lem:all_terms_even}
  1
\end{proof}

\begin{lemma}
  \label{lem:fixed_point_condition}
  \lean{IMO2025P4.lem_fixed_point_condition}
  \leanok
  \uses{def:S, def:R}
  1
\end{lemma}
...
\begin{lemma}
  \label{lem:structure_of_fixed_points}
  \lean{IMO2025P4.lem_structure_of_fixed_points}
  \leanok
  \uses{def:c_k}
  1
\end{lemma}
...
\begin{lemma}
  \label{lem:ratio_for_even}
  \lean{IMO2025P4.lem_ratio_for_even}
  \leanok
  \uses{def:R, def:c_k, def:S}
  1
\end{lemma}
\begin{proof}
  \leanok
...
\begin{lemma}
  \label{lem:growth_condition}
  \lean{IMO2025P4.lem_growth_condition}
  \leanok
  \uses{def:R, def:c_k}
  1
\end{lemma}
\begin{proof}
  \leanok
  \uses{lem:ratio_for_even}
  1
\end{proof}

\begin{lemma}
  \label{lem:decreasing_condition}
  \lean{IMO2025P4.lem_decreasing_condition}
  \leanok
  \uses{def:R, def:c_k}
  1
\end{lemma}
...
\begin{lemma}
  \label{lem:v3_transition_condition}
  \lean{IMO2025P4.lem_v3_transition_condition}
  \leanok
  \uses{def:S, def:c_k}
  1
\end{lemma}
...
\begin{lemma}
  \label{lem:growth_c4_is_5_impossible}
  \lean{IMO2025P4.lem_growth_c4_is_5_impossible}
  \leanok
  \uses{def:IsSequence, def:S, def:c_k}
  1
\end{lemma}
\begin{proof}
  \leanok
  \uses{lem:all_terms_even, lem:ratio_for_even}
  1
\end{proof}

\begin{lemma}
  \label{lem:v3_transition_v2_is_1}
  \lean{IMO2025P4.lem_v3_transition_v2_is_1}
  \leanok
  \uses{def:S}
  1
\end{lemma}
\begin{proof}
  \leanok
  \uses{lem:v3_transition_condition}
  1
\end{proof}

\begin{lemma}
  \label{lem:fixed_point_divisors}
  \lean{IMO2025P4.lem_fixed_point_divisors}
  \leanok
  \uses{def:S, def:c_k}
  1
\end{lemma}
\begin{proof}
  \leanok
  \uses{lem:ratio_for_even, lem:ratio_for_odd}
  1
\end{proof}

\begin{lemma}
  \label{lem:fixed_point_form}
  \lean{IMO2025P4.lem_fixed_point_form}
  \leanok
  \uses{def:S}
  1
\end{lemma}
\begin{proof}
  \leanok
  \uses{lem:fixed_point_divisors, lem:structure_of_fixed_points}
  1
\end{proof}

\begin{lemma}
  \label{lem:verification_of_form}
  \lean{IMO2025P4.lem_verification_of_form}
  \leanok
  \uses{def:IsSequence}
  1
\end{lemma}
\begin{proof}
  \leanok
  \uses{lem:fixed_point_form}
  1
\end{proof}

\begin{lemma}
  \label{lem:v3_transition_c3_c4_are_odd}
  \lean{IMO2025P4.lem_v3_transition_c3_c4_are_odd}
  \leanok
  \uses{def:S, def:c_k}
  1
\end{lemma}
...
\begin{lemma}
  \label{lem:transition_to_v3_positive_is_odd}
  \lean{IMO2025P4.lem_transition_to_v3_positive_is_odd}
  \leanok
  \uses{def:S}
  1
\end{lemma}
\begin{proof}
  \leanok
  \uses{lem:v3_transition_v2_is_1, lem:v3_transition_c3_c4_are_odd}
  1
\end{proof}

\begin{lemma}
  \label{lem:no_v3_zero_terms}
  \lean{IMO2025P4.lem_no_v3_zero_terms}
  \leanok
  \uses{def:IsSequence}
  1
\end{lemma}
\begin{proof}
  \leanok
  \uses{lem:decreasing_condition, lem:all_terms_even, lem:transition_to_v3_positive_is_odd, lem:no_odd_terms}
  1
\end{proof}

\begin{lemma}
  \label{lem:all_terms_divisible_by_3}
  \lean{IMO2025P4.lem_all_terms_divisible_by_3}
  \leanok
  \uses{def:IsSequence, def:c_k}
  1
\end{lemma}
\begin{proof}
  \leanok
  \uses{lem:no_v3_zero_terms}
  1
\end{proof}

\begin{lemma}
  \label{lem:c4_ge_7_impossible}
  \lean{IMO2025P4.lem_c4_ge_7_impossible}
  \leanok
  \uses{def:IsSequence, def:c_k}
  1
\end{lemma}
\begin{proof}
  \leanok
  \uses{lem:all_terms_divisible_by_3, lem:all_terms_even, lem:ratio_for_even}
  1
\end{proof}

\begin{lemma}
  \label{lem:non_fixed_must_grow}
  \lean{IMO2025P4.lem_non_fixed_must_grow}
  \leanok
  \uses{def:IsSequence, def:S, def:R}
  1
\end{lemma}
\begin{proof}
  \leanok
  \uses{lem:all_terms_divisible_by_3, lem:c4_ge_7_impossible, lem:ratio_for_even, lem:all_terms_even, lem:growth_condition, lem:growth_c4_is_5_impossible, lem:c2_is_2, lem:fixed_point_condition}
  1
\end{proof}

\begin{lemma}
  \label{lem:a1_structure}
  \lean{IMO2025P4.lem_a1_structure}
  \leanok
  \uses{def:IsSequence}
  1
\end{lemma}
\begin{proof}
  \leanok
  \uses{lem:non_fixed_must_grow, lem:all_terms_divisible_by_3, lem:c4_ge_7_impossible, lem:ratio_for_even, lem:all_terms_even, lem:growth_condition, lem:growth_c4_is_5_impossible, lem:c2_is_2, lem:fixed_point_form}
  1
\end{proof}
...
\begin{theorem}
  ...
  \lean{IMO2025P4.main_theorem}
  \leanok
  \uses{def:IsSequence, def:S}
  1
\end{theorem}
\begin{proof}
  \leanok
  \uses{lem:a1_structure, lem:verification_of_form}
  1
\end{proof}
